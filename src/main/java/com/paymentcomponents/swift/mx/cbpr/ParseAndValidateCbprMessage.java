...
public class ParseAndValidateCbprMessage {
    ...
    private static final String validCbprPacs009String = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
            "<RequestPayload>\n" +
    ...
    private static final String validCbprPacs009HeaderString = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
            "<AppHdr xmlns=\"urn:iso:std:iso:20022:tech:xsd:head.001.001.02\">\n" +
            "    <Fr>\n" +
            "        <OrgId>\n" +
            "            <Id>\n" +
    ...
    private static final String validCbprPacs009DocumentString = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
            "<Document xmlns=\"urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08\">\n" +
            "    <FICdtTrf>\n" +
            "        <GrpHdr>\n" +
            "            <MsgId>BBBB/120928-FICT/JPY/430</MsgId>\n" +
